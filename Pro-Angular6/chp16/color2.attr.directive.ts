import { ElementRef, Directive, Input, SimpleChange, Output, EventEmitter } from "@angular/core";
import { Product } from './product.model';

@Directive({
    selector: '[color2-attr]'
})
export class Color2AttrDirective {
    ...
    @Input("color2-attr")
    bgClass: string
    // bgClass will be set to the value of the expression contained in the [color2-attr] attribute.

    @Input("color2-product")
    product: Product;

    @Output("color2-category")
